...
INSERT INTO users(full_name , password , email) VALUES ($1,$2,$3) RETURNING user_id, user_name, full_name, password, email, created_at, verified_at, password_changed_at
`
